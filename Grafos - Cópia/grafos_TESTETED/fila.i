# 1 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\fila.c"
...
# 2 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\fila.c" 2
...
# 3 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\fila.c" 2
...
# 5 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\fila.c" 2
...
void libera_fila(fila_t* fila){
    ...
    if (p == ((void *)0))
    {
        fprintf((&_iob[2]), "Erro desalocando memoria da fila, ponteiro invalido!");
        exit(1);
    }
    free(p->dados);
}
...
int enqueue(void *x, fila_t* fila){
    ...
    if(tamanho == fila->tamanho_max){
        fprintf((&_iob[2]), "enqueue() em fila cheia!");
        return -1;
    }else{
...
void *dequeue(fila_t* fila){
    ...
    if(vazia(fila)){
        fprintf((&_iob[2]), "dequeue() em fila vazia!");
        exit(1);
    }
    fila->tamanho--;
    cabeca++;
