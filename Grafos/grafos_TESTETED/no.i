...
# 2 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\no.c" 2
...
# 3 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\no.c" 2
...
# 5 "C:\\Users\\Casa\\Documents\\Gustavo\\g\\grafos\\no.c" 2
...
{
    if (fonte == ((void *)0) || destino == ((void *)0)){
        fprintf((&_iob[2]),"liga_nos: ponteiros invalidos");
        exit(1);
    }
...
{
    if (no == ((void *)0)) {
        fprintf((&_iob[2]),"desliga_nos: ponteiros invalidos");
        exit(1);
    }
...
{
    if (no == ((void *)0)) {
        fprintf((&_iob[2]),"obtem_dado: ponteiros invalidos");
        exit(1);
    }
...
{
    if (no == ((void *)0)) {
        fprintf((&_iob[2]),"obtem_proximo: ponteiros invalidos");
        exit(1);
    }
...
{
    if (no == ((void *)0)) {
        fprintf((&_iob[2]),"obtem_anterior: ponteiros invalidos");
        exit(1);
    }
...
void swap_no(no_t *no1, no_t *no2){
    ...
    if (no1 == ((void *)0) || no2 == ((void *)0)) {
        fprintf((&_iob[2]),"swap_no: ponteiros invalidos");
        exit(1);
    }
